    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="招标要求" prop="zhaobiaoyaoqiu">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="招标要求"
                  v-model="ruleForm.zhaobiaoyaoqiu" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.zhaobiaoyaoqiu" label="招标要求" prop="zhaobiaoyaoqiu">
                    <span>{{ruleForm.zhaobiaoyaoqiu}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="招标内容" prop="zhaobiaoneirong">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.zhaobiaoneirong" label="招标内容" prop="zhaobiaoneirong">
                    <span v-html="ruleForm.zhaobiaoneirong"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.fabushijian = true;
          ...
          if(o=='zhaobiaoyaoqiu'){
            this.ruleForm.zhaobiaoyaoqiu = obj[o];
	    this.ro.zhaobiaoyaoqiu = true;
            continue;
          }
	...
	this.ruleForm.zhaobiaoneirong = this.ruleForm.zhaobiaoneirong.replace(reg,'../../../springbootxf481/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `zhaobiaoxinxi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.zhaobiaoxinxiCrossAddOrUpdateFlag = false;
                  this.parent.search();
